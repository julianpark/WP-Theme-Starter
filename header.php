...
<html itemscope itemtype="http://schema.org/" <?php language_attributes(); ?>>
  <head>
    ...
    <meta property="og:image" content="<?php echo get_stylesheet_directory_uri(); ?>/images/meta-image.jpg">
    ...
    <meta itemprop="image" content="<?php echo get_stylesheet_directory_uri(); ?>/images/meta-image.jpg">
    <!-- END Google Plus -->
